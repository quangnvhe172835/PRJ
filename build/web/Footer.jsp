                    ...
                    <a href="" class="text-decoration-none">
                        <h1 class="mb-4 display-5 font-weight-semi-bold">
                            <span
                                ...
                                >E</span
                            >Shopper by WANGG COMPUTER
                        </h1>
                    </a>
                    <p>
                        Welcome to WANGG COMPUTER,  
                    </p>
                    <p class="mb-2">
                        <i class="fa fa-map-marker-alt text-primary mr-3"></i>Trọ A Sơn, Ngõ 1 Cây xăng 39, Thạch Hòa, Thạch Thất, Hà Nội
                    </p>
                    <p class="mb-2">
                        <i class="fa fa-envelope text-primary mr-3"></i>wanggcomputer@gmail.com
                    </p>
                    <p class="mb-0">
                        <i class="fa fa-phone-alt text-primary mr-3"></i>0384996889<br> 
                         <i class="fa fa-phone-alt text-primary mr-3"></i>0775339993
                    </p>
                </div>
